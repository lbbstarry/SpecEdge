...
scripts/
  ...
  prepare_teaser_sam_mask.py   direct-segmentation mask behind the page-1 figure (needs a SAM checkpoint)
...
([arXiv:2511.12005](https://arxiv.org/abs/2511.12005)), separate work by the authors and
